...
**{{N_ARBOL}} archivos** ({{PESO}}) del árbol de traslado, más **{{N_DESEMP}}** extraídos de
...
`.zip` anidados: **{{N_UNICOS}} archivos existen solo dentro de un zip**. Es decir, el árbol ya
