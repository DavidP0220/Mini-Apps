...
BEATS = ["nobody has ever explained",
         "Comment one if you have had",
         "It is 1348",
         "I want to be honest",
         "And here's where it flips",
         "Why did evolution keep a useful organ",
         "Comment eight if you never knew",
         "spare tire for a road"]

def guion():
    s = open('GUION_apendice.md', encoding='utf-8').read()
