...
```
528 Hz Uriel's Healing Light 528Hz 💰 Unlock Miracles & Heart-Centered Wealth • 1 Hour
```
...
Imagen 1:
```
ruby-gold light bathing a resting figure, gold and ruby flame, celestial cathedral clouds, angelic wings of light, cosmic violet sky, ethereal, cinematic volumetric light, ultra detailed, 8k, serene spiritual atmosphere, color palette #FFD700, #9B111E, #1B1035 --ar 16:9 --style raw
```
Imagen 2:
```
wide establishing shot of ruby-gold light bathing a resting figure, gold and ruby flame, celestial cathedral clouds, angelic wings of light, cosmic violet sky, ethereal, god rays, soft mist, painterly, no text, no people faces --ar 16:9
```
Imagen 3:
```
close macro detail inspired by ruby-gold light bathing a resting figure, gold and ruby flame, celestial cathedral clouds, angelic wings of light, cosmic violet sky, ethereal, shallow depth of field, glowing particles --ar 16:9
```
Imagen 4:
```
symmetrical mandala composition based on ruby-gold light bathing a resting figure, gold and ruby flame, celestial cathedral clouds, angelic wings of light, cosmic violet sky, ethereal, sacred geometry, centered --ar 16:9
```
Imagen 5:
```
night version of ruby-gold light bathing a resting figure, gold and ruby flame, celestial cathedral clouds, angelic wings of light, cosmic violet sky, ethereal, moonlight, deep blues with gold accents --ar 16:9
```

## 6) PROMPT DE MINIATURA
```
thumbnail art: ruby-gold light bathing a resting figure, gold and ruby flame, celestial cathedral clouds, angelic wings of light, cosmic violet sky, ethereal, extreme high contrast, dramatic rim light, large empty space on the left third for text overlay, no text in image --ar 16:9
```

Texto que va ENCIMA de la miniatura (grande, dorado, 2 líneas máx): **HEALING LIGHT**
...
- [ ] 5 imágenes generadas y guardadas en `salida/uriel-13/img/`
