...
Imagen 1:
```
bazaar at golden hour, warm dust light, orange and gold ganesha iconography, marigold flowers, temple stone, sunrise light, obstacle-breaking symbolism, cinematic volumetric light, ultra detailed, 8k, serene spiritual atmosphere, color palette #FF7F11, #0B132B, #FFD700 --ar 16:9 --style raw
```
Imagen 2:
```
wide establishing shot of bazaar at golden hour, warm dust light, orange and gold ganesha iconography, marigold flowers, temple stone, sunrise light, obstacle-breaking symbolism, god rays, soft mist, painterly, no text, no people faces --ar 16:9
```
Imagen 3:
```
close macro detail inspired by bazaar at golden hour, warm dust light, orange and gold ganesha iconography, marigold flowers, temple stone, sunrise light, obstacle-breaking symbolism, shallow depth of field, glowing particles --ar 16:9
```
Imagen 4:
```
symmetrical mandala composition based on bazaar at golden hour, warm dust light, orange and gold ganesha iconography, marigold flowers, temple stone, sunrise light, obstacle-breaking symbolism, sacred geometry, centered --ar 16:9
```
Imagen 5:
```
night version of bazaar at golden hour, warm dust light, orange and gold ganesha iconography, marigold flowers, temple stone, sunrise light, obstacle-breaking symbolism, moonlight, deep blues with gold accents --ar 16:9
```

## 6) PROMPT DE MINIATURA
```
thumbnail art: bazaar at golden hour, warm dust light, orange and gold ganesha iconography, marigold flowers, temple stone, sunrise light, obstacle-breaking symbolism, extreme high contrast, dramatic rim light, large empty space on the left third for text overlay, no text in image --ar 16:9
```

Texto que va ENCIMA de la miniatura (grande, dorado, 2 líneas máx): **GOLDEN HOUR**
...
- [ ] 5 imágenes generadas y guardadas en `salida/ganesha-10/img/`
